...
mapSourceGuide.push({id:'neighborhood-boundaries',name:'SF neighborhood boundaries',url:'https://data.sfgov.org/d/j2bu-swwd',status:'Official boundary snapshots',description:'Analysis Neighborhoods (41, default), Planning notification neighborhoods (37), and SF Find / 311 neighborhoods (117) are different city definitions of San Francisco neighborhoods.',collection:'We serve reviewed DataSF GeoJSON locally, preserving polygon boundaries, holes and islands. Analysis and Notification carry the PDDL dedication; SF Find is marked public domain in DataSF metadata. Selecting a neighborhood includes places and routes that touch its boundary. Election neighborhoods remain unavailable until a reusable machine-readable source is verified. Dataset links and licenses: /neighborhoods/README.md.'});
