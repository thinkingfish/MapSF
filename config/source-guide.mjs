...
const descriptions = {
  ...
  kqed: ['KQED Arts & Culture’s editorial picks cover performances, festivals, exhibitions, and other things to do across the Bay Area.', 'We inspect recent Do List articles for explicit event summaries at verified San Francisco venues. Current extraction supports the reviewed Chinatown art-event format; other articles remain discovery material. The multi-venue event uses a station pin, with its other addresses in the details. Article publication dates and headline geography are not event dates or locations. The RSS feed covers Arts across the Bay Area.'],
