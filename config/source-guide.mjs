...
mapSourceGuide.push({id:'neighborhood-boundaries',name:'SF neighborhood boundaries',url:'https://data.sfgov.org/d/j2bu-swwd',status:'Official boundary snapshots',description:'Analysis Neighborhoods (41, default), Planning notification neighborhoods (37), SF Find / 311 neighborhoods (117), and historical Election neighborhoods (26, 2012 precinct definitions) are different city definitions of San Francisco neighborhoods.',collection:'We serve reviewed DataSF GeoJSON locally, preserving polygon boundaries, holes and islands. Analysis, Notification and Election carry the PDDL dedication; SF Find is marked public domain in DataSF metadata. Selecting a neighborhood includes places and routes that touch its boundary. Election areas are dissolved from official precinct assignments, with readable names verified against Election Map SF; five unassigned source polygons remain excluded. Dataset links and licenses: /neighborhoods/README.md.'});
