...
| --- | --- | --- |
| KQED The Do List | Internal discovery research only | Removed from the operational registry, public source/RSS guides, and event feed at the owner’s request. The single-event parser was too brittle for automation. [Retained research](docs/journal/2026-09-11-kqed-source.md). |
